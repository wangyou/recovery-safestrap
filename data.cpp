...
void DataManager::SetDefaultValues()
{
...
#ifdef BUILD_SAFESTRAP
	// Safestrap
        mConst.SetValue(SS_VERSION_VAR, SS_VERSION_STR);
	...
	mConst.SetValue(TW_SS_DEFAULT_VIRT_SYSTEM_SIZE, DEFAULT_VIRT_SYSTEM_SIZE);
	mConst.SetValue(TW_SS_DEFAULT_VIRT_SYSTEM_MIN_SIZE, DEFAULT_VIRT_SYSTEM_MIN_SIZE);
	mConst.SetValue(TW_SS_DEFAULT_VIRT_SYSTEM_MAX_SIZE, DEFAULT_VIRT_SYSTEM_MAX_SIZE);
	mConst.SetValue(TW_SS_DEFAULT_VIRT_DATA_SIZE, DEFAULT_VIRT_DATA_SIZE);
	mConst.SetValue(TW_SS_DEFAULT_VIRT_DATA_MIN_SIZE, DEFAULT_VIRT_DATA_MIN_SIZE);
	mConst.SetValue(TW_SS_DEFAULT_VIRT_DATA_MAX_SIZE, DEFAULT_VIRT_DATA_MAX_SIZE);
	mConst.SetValue(TW_SS_DEFAULT_VIRT_CACHE_SIZE, DEFAULT_VIRT_CACHE_SIZE);
	mConst.SetValue(TW_SS_DEFAULT_VIRT_CACHE_MIN_SIZE, DEFAULT_VIRT_CACHE_MIN_SIZE);
	mConst.SetValue(TW_SS_DEFAULT_VIRT_CACHE_MAX_SIZE, DEFAULT_VIRT_CACHE_MAX_SIZE);
#endif
